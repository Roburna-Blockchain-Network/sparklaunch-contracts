...
contract SparklaunchSaleERC20 {
        ...
        onlyFactory
    {
        ...
        uint256 tokensToSell = sale.hardCap.mul(sale.tokenPriceInERC20).div(10**tokenERC20decimals);
    ...
    function _participate(
       ...
       require(IERC20(tokenERC20).allowance(user, address(this)) >= amountERC20, "Insuficcient allowance");
        ...
        uint256 amountOfTokensBuying = (amountERC20).mul(sale.tokenPriceInERC20).div(tokenERC20decimals);
